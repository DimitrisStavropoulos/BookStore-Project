...
namespace Store01.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    ViewBag.ReturnUrl = returnUrl; //Keep url if unsuccesful login, to redirect after
                    return View(model);            //succesful login.
            }
        }
        ...
        //same as login, store url redirect after unsuccessful register
        ...
        public async Task<ActionResult> Register(RegisterViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {   
                    //Add user that registers to role:User.
        ...
        public ActionResult ResetPassword(string code)
        {
            ...
            //Identity code allows reset of password on basis that a user can be
            //emailed first see ForgotPasword() commmented. Here fictional emails are used so this step is ommitted
